import 'package:cola_splash_screen/widgets/color_loader.dart';
import 'package:cola_splash_screen/widgets/header_box.dart';
              ...
              children: [
                Center(
                  child: Container(
                      ...
                      height: 300,
                      child: Lottie.asset(
                          "assets/drone.json") //Lottie.network('https://assets1.lottiefiles.com/packages/lf20_xgrrauhd.json')
                      ),
                ),
                Center(
                  child: Container(
                ...
                HeaderBox(color: Color(0xFF000343)),
                SizedBox(
                  height: 20,
                ),
                ColorLoader(),
